...
import (
	...
	repositoryMocks "github.com/paw1a/eschool-core/service/mocks/repository"
...
func TestCourseService_ConfirmDraftCourse(t *testing.T) {
	...
	for _, test := range testTable {
		t.Run(test.name, func(t *testing.T) {
			...
			courseService := service.NewCourseService(courseRepo, lessonRepo, schoolRepo, statRepo)
